...
<link href="/Public/bootstrap-3.3.5/css/bootstrap.min.css" rel="stylesheet">
<link href="/Public/tags/bootstrap-tagsinput.css" rel="stylesheet">
...
<script type="text/javascript" src="/Public/umeditor/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/bootstrap-3.3.5/js/bootstrap.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/tags/bootstrap-tagsinput.min.js"></script>
            ...
            <div style="" class="leftWrap">
                ...
                <div class="detailed_banner">
                    <div class="upload_Img">
                        <input value="上传封面图" id="fileToUpload" name="fileToUpload" onchange="ajaxFileUpload();"
                               type="file">
                        <span><i class="icon-tianjiashangpin"></i><a href="javascript:;">点击</a>上传文章头图（建议头图尺寸为710x300px或以上）</span>
                    </div>
                    <div class="loading" style="display: none;"><img src="/Public/images/loading.gif"></div>
                </div>
                <div class="share_Slct">
                    <div class="slct">
                        <div class="tab_Slct" id="tab_category"><span id="span_category"><i></i>文章类别</span> <em><i></i></em>
                        </div>
                        <ul id="ul_category" style="display:none;z-index: 1000">
                            <input type="hidden" id="category" name="category"/>
                            <input type="hidden" id="tag" name="tag"/>
                            <?php if(is_array($categoryList)): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a class="slct_type slct_category" data-category="<?php echo ($item["id"]); ?>" href="javascript:;"><?php echo ($item["name"]); ?></a>
                ...
                <div class="share_Slct">
                    <div class="slct">
                        <div class="tab_Slct" id="tab_country"><span id="span_country"><i></i>国家</span> <em><i></i></em>
                        </div>
                        <ul id="ul_country" style="display:none;z-index: 1000">
                            <input type="hidden" id="country" name="country"/>
                            <?php if(is_array($countryList)): $i = 0; $__LIST__ = $countryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a class="slct_type slct_country" data-country="<?php echo ($item["id"]); ?>" href="javascript:;"><?php echo ($item["name"]); ?></a>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="source">
                    ...
                    外链来源: <input type="checkbox" id="check_source" name="check_source">
                    </div>
                    <div class="_source" style="margin-left: 5px;float: left;">
                        标价:<input type="text" name="source_price" style=" width: 50px">
                    来源: <input type="text" name="source_name">
                    来源地址URL: <input type="text" name="source_url">
                    </div>
                </div>
                <div class="tag">
                ...
                <div class="edit_Tit" id="my_Share">
                    <input class="xilie_input" id="title" name="title" default_value="我的文章标题" value="我的文章标题" style=""
                           type="text">
                </div>
        ...
        <aside class="guide_info">
            <div style="position: static; top: 0px;" class="rightPanel zhu">
                <div class="edt_Tit">
                    ...
                    <a href="javascript:;" class="pop-close close"><i class="icon-cross-lighter"><!--[if lt IE 8]>x
                        <![endif]--></i></a></div>
                <p>展示消费主张，分享兴趣爱好，传播深刻体会，获取经验知识，值客原创欢迎您的投稿，请根据<a target="_blank" href="#">《投稿指引》</a>和<a target="_blank"
                                                                                                       href="http://post.smzdm.com/about/">《投稿须知》</a>了解并熟悉投稿流程和审核要求。
                </p>
            </div>
            <div class="rightPanel jiayi" id="xz_jianyi" style="visibility: hidden; position: static; top: 0px;">
                <div class="tishi_show" id="guide_1" style="display:none;">
                    ...
                    <p>
                        开箱晒物是分享购物心情和心爱产品最为简单和直接的方式，请通过图文并茂的内容展示告诉大家你买到了什么，并对产品的外观、功能以及使用等方面进行介绍，以及关于购买转运、尺码试用等方面的信息。高品质产品、高人气新品、新奇特之物的晒单将会获得更高的人气。</p>
                </div>
                ...
                <div class="tishi_show" id="guide_4" style="display:none;">
                    <div class="edt_Tit">
                        ...
                        <a href="javascript:;" class="pop-close close active"><i class="icon-down">
                            <!--[if lt IE 8]>x<![endif]--></i></a></div>
                    <p>
                        在生活中，我们都有很多不同的经历、爱好和特长，比如旅游、摄影、装修、美食、DIY等等，这其中同样会涉及到消费的方方面面。无论你是玩家还是行家，通过分享你的这些生活中的经历，你会找到更多与你志同道合的伙伴。同时你也可以分享你对生活、购物等方面的心情和感受，告诉大家你精彩的每一天。如果文章中有涉及到具体的商品，请同插入卡片的方式进行展示。</p>
                </div>
...
<script>
    ...
    $('input_tag').tagsinput('add', { "value": 1 , "text": "Amsterdam"  });
    $('input_tag').tagsinput('add', { "value": 4 , "text": "Washington" });
    $('input_tag').tagsinput('add', { "value": 7 , "text": "Sydney"     });
    $('input_tag').tagsinput('add', { "value": 10, "text": "Beijing"    });
    $('input_tag').tagsinput('add', { "value": 13, "text": "Cairo"      });
</script>
